...
for i = 1:length(correlated_struct)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            if i == 13
                correlated_struct(13).correlated_data(2).red_data =correlated_struct(13).correlated_data(1).red_data;
                correlated_struct(13).correlated_data(3).red_data =correlated_struct(13).correlated_data(1).red_data;

            else
                for k = 1:length(correlated_struct(i).red_info(1).particle_tracked)
                    red_chords = correlated_struct(i).red_info(1).crop_coordinates{k};
                    red_position = correlated_struct(i).red_info(1).particle_tracked{k};
                    ...
                    length_of_trace = size(red_position, 1);
