function save_these_results = my_fast_particle_finding(trace,t, max_distance_for_connect)
fittingcell = {};
gof_results = {};
datacell = {};
height = [];
...
% %%
% 
% function save_these_results = my_fast_particle_finding(trace,t)
% fittingcell = {};
% gof_results = {};
% datacell = {};
% height = [];
...
%         [fitresult, gof] = fit( xData, yData, ft, opts );
%         if gof.rsquare < 0.05
%             [vals, inds] = findpeaks(yData,xData,'SortStr','descend');
%             if isempty(inds) || abs(inds(1)- trace.b) > 8
%                 continue
%             end
%             trace.b = inds(1);
%             trace.bmin=trace.b-5;
